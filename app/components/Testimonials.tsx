...
const testimonials = [
  ...
  },
  {
    ...
    text: "Não sou de deixar review mas esse merece. R$ 14,90 pelo conteúdo que tem aqui é uma aberração. Passei anos comprando coisa cara achando que era o produto, mas era o método que tava errado.",
